...
Усі посилання можна знайти на сторінці http://waze.com.ua`;
    ...
    // -------------------------------------------------------------------------
    // Надсилання коментаря через нативний SDK метод.
    // sdk.DataModel.MapUpdateRequests.addComment() — офіційний метод,
    // підтверджений самим WME (замість застарілого W.model.updateRequestSessions.addComment)
    // -------------------------------------------------------------------------
